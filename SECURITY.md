...
The Directory Python SDK maintainers take all security issues in the project
seriously. Thank you for improving the security of the Directory Python SDK. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

The Directory Python SDK leverages GitHub's private vulnerability reporting.
